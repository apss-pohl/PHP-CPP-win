...
Value &Value::operator+=(uintmax_t value)            { return Arithmetic<std::plus>(this).assign(value); }
...
Value &Value::operator-=(uintmax_t value)            { return Arithmetic<std::minus>(this).assign(value); }
...
Value &Value::operator*=(uintmax_t value)            { return Arithmetic<std::multiplies>(this).assign(value); }
...
Value &Value::operator/=(uintmax_t value)            { return Arithmetic<std::divides>(this).assign(value); }
...
Value &Value::operator%=(uintmax_t value)            { return operator=(numericValue() % value); }
...
Value Value::operator+(uintmax_t value)              { return Arithmetic<std::plus>(this).apply(value); }
...
Value Value::operator-(uintmax_t value)              { return Arithmetic<std::minus>(this).apply(value); }
...
Value Value::operator*(uintmax_t value)              { return Arithmetic<std::multiplies>(this).apply(value); }
...
Value Value::operator/(uintmax_t value)              { return Arithmetic<std::divides>(this).apply(value); }
...
Value Value::operator%(uintmax_t value)              { return Value(numericValue() % value); }
 ...
 *  @return long
 */
uintmax_t Value::numericValueUnsigned() const
{
    return zval_get_long(_val);
}
